...
function gerarRecibo() {
    ...
    const receiptContent = `
        Planeta Agua - Nota Digital
        Rua do Ribeirao, 287 centro
        ...
        Pedido:
        ${waterQuantity} garrafas de ${waterBrand.replace('_', ' ')} - Preco Uni.: R$ ${waterPrice.toFixed(2)} - Total: R$ ${waterTotal.toFixed(2)}
        ${gasQuantity} botijoes de gas - Total: R$ ${(gasTotal).toFixed(2)}
